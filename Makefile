...
BUILD_TARGETS = \
	...
	simple batched batched-bench save-load-state server gguf llama-bench libllava.a llava-cli llava-test baby-llama beam-search  \
...
override CXXFLAGS      := $(MK_CPPFLAGS) $(CPPFLAGS) $(MK_CXXFLAGS) $(CXXFLAGS) -Iinclude
...
libllava.a: examples/llava/llava.cpp examples/llava/llava.h examples/llava/clip.cpp examples/llava/clip.h common/stb_image.h common/base64.hpp ggml.o llama.o $(COMMON_DEPS) $(OBJS)
	$(CXX) $(CXXFLAGS) $(OPENCV_CXXFLAGS) -static -fPIC -c $< -o $@ -Wno-cast-qual
